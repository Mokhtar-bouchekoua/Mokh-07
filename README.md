...
### 🅿️ [FacPark](https://github.com/mokhtar-bouchekoua/FacPark)
Smart parking with AI plate recognition  
YOLOv11 • LPRNet OCR • RAG chatbot  
`Python` `FastAPI` `React` `LangChain`

</td>
<td width="50%">

### 💊 [Paramedics BI](https://github.com/mokhtar-bouchekoua/paramedics-bi-dashboard)
AI-powered financial dashboard  
Health score • What-If engine • Groq RAG  
`Streamlit` `Groq` `Plotly` `LangChain`
...
Real-time system for autonomous vehicles  
Transformers • MQTT • Angular dashboard  
`FastAPI` `Angular` `PyTorch` `Firebase`
...
**🏆 Best PFE Award 2023**  
NPK sensor • Soil analysis • Android app  
`Arduino` `Flutter` `C`
...
⭐ From [mokhtar-bouchekoua](https://github.com/mokhtar-bouchekoua) | Sfax, Tunisia 🇹🇳
